...
public class macam {
    ...
    static void showBarang(ArrayList<ArrayList<String>> x, String Filename_1, String Filename_2, String Filename_3, String Filename_4, String cat)
    {
        try
        {
            File cari_1 = new File(Filename_1+".txt");
            File cari_2 = new File(Filename_2+".txt");
            File cari_3 = new File(Filename_3+".txt");
            File cari_4 = new File(Filename_4+".txt");
            Scanner a_file_1 = new Scanner(cari_1);
            Scanner a_file_2 = new Scanner(cari_2);
            Scanner a_file_3 = new Scanner(cari_3);
            Scanner a_file_4 = new Scanner(cari_4);
            ...
            while (a_file_1.hasNextLine())
            {
                ...
                String data_4 = a_file_4.nextLine();
                macam.write(a + ". " + data_1 + " - $" + data_2 + " | Stock : " + data_3 + " | " + cat + " : " + data_4);
                a++;
    ...
    // Delete barang
    static void itemRemove(String Filename, String Filename_2, String Filename_3, String Filename_4, int rak, String yes)
    {
        try
        {        
            ...
            ipt_3.close();
            FileWriter ipt_4 = new FileWriter(Filename_4+".txt");
            for (int d = 0; d<stok.size();d++)
            {
                ipt_4.write(stok.get(d)+"\n");
            }
            ipt_4.close();
        }
        catch(IOException e)
    ...
    static void updateStock(String Filename_1, int rak, int amt)
    {
        try
        {
            File cari_1 = new File(Filename_1+".txt");
            ...
            FileWriter ipt = new FileWriter(Filename_1+".txt");
