...
class source extends catalog
{
    ...
    public void add()
    {
        ...
        macam.addStr("barangSRC", nama);
        macam.addInt("hargaSRC", harga);
        macam.addInt("stokSRC", jumlah_barang);
        macam.addStr("chipSRC", chip);
    }

    public void show()
    {
        macam.showBarang(x, "barangSRC", "hargaSRC", "stokSRC", "chipSRC", "Chip");
    }
    ...
    public void update()
    {
        ...
        macam.lanjut();
        chip = macam.inputString("Chip : ");
        macam.editItem("barangSRC", rak, nama);
        macam.editNum("hargaSRC", rak, harga);
        macam.editNum("stokSRC", rak, jumlah_barang);
        macam.editItem("chipSRC", rak, chip);
    }
    ...
    public void remove()
    {
        macam.showBarang(x, "barangSRC", "hargaSRC", "stokSRC", "chipSRC", "Chip");
        rak = macam.inputInt("Pilih rak : ");
        macam.itemRemove("barangSRC", "hargaSRC", "stokSRC", "chipSRC", rak, chip);
    }
    ...
    public void buy()
    {
        while (true)
        {
            ...
            macam.updateStock("stokSRC", rak, amt);
            macam.writenum(byr);
            total = total + byr*amt;
